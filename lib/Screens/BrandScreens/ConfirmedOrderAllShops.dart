...
class ConfirmedOrderAllShops extends StatefulWidget {
  final String brandUid;

  const ConfirmedOrderAllShops({Key? key, required this.brandUid}) : super(key: key);

  @override
  State<ConfirmedOrderAllShops> createState() => _ConfirmedOrderAllShopsState();
}

class _ConfirmedOrderAllShopsState extends State<ConfirmedOrderAllShops> {
  ...
  Future<void> _getShopsWithPendingOrders() async {
    try {
      final querySnapshot = await FirebaseFirestore.instance
          ...
          .where('CurrentOrder', isEqualTo: "yes").where('Confirmed',isEqualTo: 'yes')
          .get();
