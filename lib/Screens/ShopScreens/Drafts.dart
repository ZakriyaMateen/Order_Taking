...
class DraftsShop extends StatefulWidget {
  ...
  const DraftsShop({Key? key, required this.brandUid, required this.clientUid, required this.shopName, required this.clientVat, required this.currencyRates, required this.brandCurrency, required this.clientCurrency}) : super(key: key);
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (BuildContext context,  snapshot) {
              ...
              snapshot.data!.docs.forEach((document) {
                ...
                // totalAmount = double.parse(orderMap["totalAmount"]);
              ...
              try{
                for (var i = 0; i < orders.length; i++) {
                              ...
                              child: GestureDetector(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: FancyShimmerImage(
                                    ...
                                    errorWidget: Icon(Icons.error,color: Colors.grey[400],size: h*0.02,),
                                  ),
                                ),
                              ),
                            ),
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(e.toString()),duration: Duration(seconds:20),));
              }
