...
class Confirmed extends StatefulWidget {
  ...
  const Confirmed({Key? key, required this.brandUid, required this.clientUid, required this.shopName, required this.clientVat, required this.brandCurrency, required this.clientCurrency, required this.currencyRates}) : super(key: key);
    ...
    return Scaffold(
      // drawer: drawer(h,w,context,widget.brandUid),
        ...
        appBar:AppBar(
            ...
            centerTitle: false,
            title: text("Confirmed Offer",Colors.white, FontWeight.bold, h*0.018)
        ),
